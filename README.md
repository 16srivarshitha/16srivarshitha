...
**Silicon & Hardware** ![RISC-V](https://img.shields.io/badge/risc--v-black?style=for-the-badge&logo=riscv&logoColor=white)
![NGSPICE](https://img.shields.io/badge/NGSPICE-A00000?style=for-the-badge&logo=electricity&logoColor=white)
![Magic VLSI](https://img.shields.io/badge/Magic%20VLSI-800080?style=for-the-badge&logo=media-tek&logoColor=white)
...
- **Deep Learning**: Analyzing latent space regularization in Variational Autoencoders ($\beta$-VAE) and building Transformers from scratch.
- **Computer Architecture**: Designing and verifying single-core RISC-V processors and exploring pipelining techniques.
- **VLSI**: Working on custom circuit layouts and simulations using NGSPICE and Magic.
